/* $Id: TreeReader.cpp 519 2010-11-19 09:21:46Z /O=GRID-FR/C=FR/O=CNRS/OU=LPSC/CN=Benoit Clement $ */
...
//============================================================
Bool_t TreeReader::GetEntry(int entry)
  //============================================================
{
